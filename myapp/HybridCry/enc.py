...
def aesenc():
    ...
    f=open("myapp\HybridCry\F2\BinfileName11.bin")
    plaintext=''
    for i in f:
        plaintext+=i
    f.close()
    ...
    f2=open('myapp\HybridCry\F2\BinfileName11.bin','wb')
    f2.write(ciphertext)
...
def desenc():
    ...
    f=open("myapp\HybridCry\F2\BinfileName12.bin")
    ...
    f2=open('myapp\HybridCry\F2\BinfileName12.bin','wb')
    f2.write(e)
...
def rc4enc():
    ...
    f=open("myapp\HybridCry\F2\BinfileName13.bin")
    ...
    f2=open('myapp\HybridCry\F2\BinfileName13.bin','wb')
    f2.write(cipher)
...
def stegnoimg(k,iv,di,r,l):
    ...
    secret = lsb.hide("myapp\HybridCry\sbushiv.jpg",c)
    secret.save("myapp\HybridCry\s1.png")
